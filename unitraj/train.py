...
from unitraj.utils.base_config import BaseConfig
from unitraj.utils.utils import find_latest_checkpoint, set_seed
...
def train(cfg):
    ...
    trainer = pl.Trainer(
        ...
        logger=(
            None
            if cfg.debug
            else WandbLogger(project="unitraj", name=cfg.exp_name, id=cfg.exp_name)
        ),
